...
(function (root) {
  ...
  function nominate(gray, pageW, pageH, coarse, scales, perScale, pyramid) {
  ...
  function upscaleFor(ready, assets, opts) {
    ...
    if (assets.allowUpscale) {
      ...
      if (dpi && dpi < COARSE_DPI) return COARSE_PAGE_UPSCALE;
      if (short && short < TINY_TEMPLATE_SHORT) return COARSE_PAGE_UPSCALE;
    }

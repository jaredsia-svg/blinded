...
(function (root) {
  ...
  const CATEGORIES = {
    person:   { prefix: 'PERSON',        description: "a person's name" },
    term:     { prefix: 'TERM',          description: 'a term chosen by the reviewer' },
    email:    { prefix: 'EMAIL',         description: 'an email address' },
    phone:    { prefix: 'PHONE',         description: 'a telephone number' },
    card:     { prefix: 'CARD',          description: 'a payment card number' },
    iban:     { prefix: 'BANK_ACCOUNT',  description: 'a bank account number' },
    ssn:      { prefix: 'SSN',           description: 'a US Social Security number' },
    ip:       { prefix: 'IP_ADDRESS',    description: 'an IP address' },
    url:      { prefix: 'URL',           description: 'a web address' },
    address:  { prefix: 'ADDRESS',       description: 'a street address' },
    postcode: { prefix: 'POSTCODE',      description: 'a postal code' },
    dob:      { prefix: 'DATE_OF_BIRTH', description: 'a date of birth' },
    logo:     { prefix: 'LOGO',          description: 'a logo or other image' },
    manual:   { prefix: 'REDACTED',      description: 'a region covered by hand' },
  };
  ...
  function assign(items, overrides) {
    ...
    for (const group of groups.values()) {
      ...
      const suggested = spec.prefix + '_' + counters[category];
